    ...
    <section className="lg:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-1 lg:text-xl text-justify">
          ...
          <div>
            ...
            <Link
              href="/"
              className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-gray-600 to-gray-800 hover:bg-slate-800 text-white mt-3"
            >
